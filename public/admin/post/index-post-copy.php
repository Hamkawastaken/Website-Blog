                    ...
                    <div class=" bg-white">
                      <img class="w-full rounded-t-xl" style="height: 200px;" src="../../../images/<?= $post['attachment']?>" alt="Image Description">
                        <div class="card-body">
                          ...
                          <a class="mt-4 py-2 px-3 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-md border border-transparent bg-blue-600 text-white" href="./detail-post.php?id=<?=$post['id_post']?>">Details</a>
                          <a class="mt-4 py-2 px-3 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-md border border-transparent bg-green-600 text-white" href="./edit-post.php?id=<?=$post['id_post']?>">Edit</a>
                          <a class="mt-4 py-2 px-3 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-md border border-transparent bg-red-600 text-white" href="./delete-post.php?id=<?=$post['id_post']?>">Delete</a>
                        </div>
                    </div>                                                
                  </div>
                  <?php endforeach;?>
