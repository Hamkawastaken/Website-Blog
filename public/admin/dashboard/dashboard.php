...
<?php require_once '../components/navbar.php'?>
  ...
  <!-- ========== END HEADER ========== -->
				...
				<main class="h-full overflow-y-auto  max-w-full  pt-4">
					<div class="card-wrapper flex flex-col justify-center items-center" style="gap: 1rem;">
						<div class="card" style="width: 20rem;">
								<div class="card-body">
									<div class="flex gap-6 items-center justify-between">
                                    <div class="flex flex-col gap-5">
										<h4 class="text-gray-600 text-lg font-semibold">Post</h4>
										<div class="flex flex-col gap-[18px]">
										<h3 class="text-[21px] font-semibold text-gray-600"><?= count($posts->all())?></h3>
						...
						<div class="card" style="width: 20rem;">
								<div class="card-body">
									<div class="flex gap-6 items-center justify-between">
                                    <div class="flex flex-col gap-5">
										<h4 class="text-gray-600 text-lg font-semibold">Category</h4>
										<div class="flex flex-col gap-[18px]">
										<h3 class="text-[21px] font-semibold text-gray-600"><?= count($categories->all())?></h3>
										<div class="flex items-center gap-1">
                                           <span class="flex items-center justify-center w-5 h-5 rounded-full bg-red-400">
											<i class="ti ti-arrow-down-right text-red-500"></i>
										   </span>
						...
						<div class="card" style="width: 20rem;">
								<div class="card-body">
									<div class="flex gap-6 items-center justify-between">
                                    <div class="flex flex-col gap-5">
										<h4 class="text-gray-600 text-lg font-semibold">Tags</h4>
										<div class="flex flex-col gap-[18px]">
										<h3 class="text-[21px] font-semibold text-gray-600"><?= count($tags->all())?></h3>
										<div class="flex items-center gap-1">
                                           <span class="flex items-center justify-center w-5 h-5 rounded-full bg-red-400">
											<i class="ti ti-arrow-down-right text-red-500"></i>
										   </span>
					...
					<div class="container full-container py-5 flex flex-col gap-6">
						<div class="card h-full">
								<div class="card-body">
									<h4 class="text-gray-600 text-lg font-semibold mb-6">Dashboard </h4>
										...
										<table class="text-left w-full whitespace-nowrap text-sm">
											<thead class="text-gray-700">
												<tr class="font-semibold text-gray-600">
													...
													<th scope="col" class="p-4">Postingan</th>
