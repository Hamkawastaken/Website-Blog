...
<?php require_once '../components/navbar.php'?>
  ...
  <!-- ========== END HEADER ========== --></div>
            ...
            <div class="card">
                ...
                <h6 class="text-lg text-gray-600 font-semibold">Tags List</h6>
                <div class="input-group">
                  <input type="text" id="search" placeholder="Search Tags" class="h-10 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-red-500 focus:border-red-500 block w-full p-2.5" style="border-radius: 999px;">
                </div>
                </div>
								...
								<div class="card-body">
									<div id="content" class="relative overflow-x-auto">
										...
										<table class="text-left w-full whitespace-nowrap text-sm">
											...
											<tbody>
                        <?php $no = ($page - 1) * $limit;?>
                        <?php foreach ($tags->paginate($start, $limit) as $tag) :?>
                        <?php $no++;?>
												<tr>
